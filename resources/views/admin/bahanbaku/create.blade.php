...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Tambah Bahan Baku</h1>
</div>
...
<div class="col-lg-8">
    <form method="post" action="/admin/bahanbaku" class="mb-5" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            {!! Form::text('nama', old('nama'), ['class' => 'form-control', 'placeholder' => 'Masukkan Nama Bahan Baku', 'required', 'autofocus']) !!}
        ...
        <div class="mb-3">
            ...
            {!! Form::text('deskripsi', old('deskripsi'), ['class' => 'form-control', 'placeholder' => 'Deskripsi Bahan Baku', 'required']) !!}
